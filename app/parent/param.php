...
<?php 
  ...
  <input checked class='custom-checkbox-input' type='checkbox' id='custom-checkbox-discovery". $i ."'/>
...
<h3 class='param-section-title'> Type d'événement </h3>

<ul class='param-list'>
    <li> <p> Réunion </p> <div class='custom-checkbox'>
  <input checked class='custom-checkbox-input' type='checkbox' id='custom-checkbox-discovery-reunion'/>
  ...
  <input checked class='custom-checkbox-input' type='checkbox' id='custom-checkbox-discovery-soiree'/>
  ...
  <input checked class='custom-checkbox-input' type='checkbox' id='custom-checkbox-discovery-nothing'/>
...
<ul class='param-list'>
  ...
  <input checked class='custom-checkbox-input' type='checkbox' id='custom-checkbox-discovery-notif'/>
...
<ul class='param-list'>
  <li> <p> Voir événements passés </p> <div class='custom-checkbox'>
